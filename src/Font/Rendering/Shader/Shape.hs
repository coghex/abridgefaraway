...
module Font.Rendering.Shader.Shape (
    module T,
...
import           Font.Utils
import           Font.Rendering.Shader.Utils
import           Font.Rendering.Shader.Shape.Types as T
import           Graphics.Rendering.OpenGL hiding (Bitmap, Matrix)
import           Graphics.GL (glUniformMatrix4fv)
import           Foreign
import           Control.Monad
import           Font.Rendering.Shader.TH
