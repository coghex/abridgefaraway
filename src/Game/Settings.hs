...
nfitlist = [
           [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --0
         , [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --1
         , [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --2
         , [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --3
         , [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --4
         , [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --5
         , [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --6
         , [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --7
         , [0, 1, 2, 3, 4, 5, 12, 13, 14, 17, 18, 19, 20, 22, 23, 24, 32, 33, 34, 36, 93, 96, 99] --8
         , [6, 9, 72, 75, 87, 91]                                                                 --9
         , [7, 10, 66, 67, 68, 73, 76, 97]                                                        --10
         , [8, 11, 74, 77, 88, 89]                                                                --11
         , [6, 9, 72, 75, 87, 91]                                                                 --12
         , [7, 10, 66, 67, 68, 73, 76, 97]                                                        --13
         , [8, 11, 74, 77, 88, 89]                                                                --14
         , [15, 16, 17]
           ]::[[Int]]
