...
importSettings = Lua.run $ do
  ...
  return $ makeSettings (sw::Int) (sh::Int) (fs::Bool) (fsize::Int) (fps::Double) (timespeed::Int) (animspeed::Int) (history::Int) (precision::Int) (gridw::Int) (gridh::Int) (fudge::Int) (salt::Int) (sugar::Float) (vigor::Int) (minnconts::Int) (maxnconts::Int) (minsize::Int) (maxsize::Int) (minnspots::Int) (maxnspots::Int) (sealevel::Int) (peaklevel::Int)

makeSettings :: Int -> Int -> Bool -> Int -> Double -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Float -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Int -> Settings
makeSettings sw sh fs fsize fps ts as h p gw gh f salt sugar vigor minnc maxnc mins maxs minns maxns sl pl =
