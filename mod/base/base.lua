...
function initLua ()
    ...
    menu2:addMenu ("wparams",-4.0, 4.0)
    menu2:addMenuBit ("wparams","text","World Parameters")
    menu2:addMenuBit ("wparams","slider","nConts:1-1000,60")
    menu2:addMenuBit ("wparams","slider","nSpots:1-10,4")
    menu2:addMenuBit ("wparams","slider","Seed:1-1000,999")
    menu2:addMenuBit ("wparams","slider","Width:1-1000,10")
    menu2:addMenuBit ("wparams","slider","Height:1-1000,8")
    ...
    game1:addWorld (8,8,24,18,"dat/tex/world/")
