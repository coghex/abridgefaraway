...
function initLua ()
    ...
    menu2:addMenuBit ("submenu1","slider","nConts:1-10,1")
    menu2:addMenuBit ("submenu1","slider","Seed:1-1000,12")
    menu2:addMenuBit ("submenu1","slider","Seed:1-1000,123")
    menu2:addMenuBit ("submenu1","slider","Seed:1-1300,1234")
