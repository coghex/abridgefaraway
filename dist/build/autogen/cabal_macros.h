...
/* package abridgefaraway-0.1.0.0 */
#define VERSION_abridgefaraway "0.1.0.0"
...
/* package StateVar-1.1.0.4 */
#define VERSION_StateVar "1.1.0.4"
...
/* package type-operators-0.1.0.4 */
#define VERSION_type_operators "0.1.0.4"
#define MIN_VERSION_type_operators(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
...
#define CURRENT_COMPONENT_ID "abridgefaraway-0.1.0.0"

#define CURRENT_PACKAGE_KEY "abridgefaraway-0.1.0.0"
